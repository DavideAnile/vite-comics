...
import AppContentJumbo from "./AppContentJumbo.vue";
...
<template>
    <AppContentJumbo></AppContentJumbo>
    <div class="my-container">
        
        <div class="content">

            <AppContentCard v-for="card in cards" :img="card.thumb" :title="card.series"></AppContentCard>
